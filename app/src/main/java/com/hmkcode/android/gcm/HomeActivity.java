...
public class HomeActivity extends ListActivity {
       ...
       lv1 = getListView();
        ...
        lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Toast.makeText(HomeActivity.this, "Item with id "+name , Toast.LENGTH_SHORT).show();
    ...
    public void gopublic(View v){
        Intent intent = new Intent(HomeActivity.this, PP.class);
        startActivity(intent);
    }
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            String newurl= url_all_products+"?user="+RegId;
            String json = jParser.makeServiceCall(newurl, JSONParser.GET);
